...
Quick start::
    ...
    from almready.balance_config import classify_position
    from almready.balance_config.clients import get_client_rules
    from almready.balance_config.schema import SUBCATEGORY_LABELS
...
from almready.balance_config.classifier import (
